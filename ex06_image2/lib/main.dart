      ...
      body: Column(   // 열이 중심이므로
        ...
        children: [
          ...
          Image.asset(
            ...
            alignment: Alignment.topLeft,
            // 사이즈를 둘 다 주면 fill이 아니라 contain이 된다.
            width: 150.0,
            height: 100.0,
          ),
          const SizedBox(height: 5,),
          Image.asset(
            ...
            width: 150.0,     // 사이즈를 둥 다 주면 fill이 아니고
          ...
          Image.asset(
            ...
            width: 320.0,   // 옵션은 한 줄에 하나씩 하는 것이 수정할 때 편함.
            height: 50.0,
          ),
        ],
      ),

class Marine
{
  // 앞에서 했던 방식. 이 것을 간단하게 사용한 것이 아래 방법
  // late int health;
  // late int attack;
  //
  ...
  // 자바로 보면 static 선언한 것이다.
  const Marine(this.health, this.attack);
  /*
   하나의 객체로 여러번 사용하고 싶다면 const 생성자를 이용하여 객체를 생성해야 한다.
   플러터의 모든 객체에 다양하게 사용되고 있다.
  */
}
...
void main()
{
  ...
  Marine unit2 = Marine(10, 1);   // 새로 만들어진 것임(new). 변수명이 다르니
  Marine unit3 = const Marine(10, 1);
  Marine unit4 = const Marine(10, 1);   // 같은 것을 사용. 메모리 절약
  Marine unit5 = new Marine(10, 1);
  Marine unit6 = new Marine(10, 1);

  /*
   identical(객체1, 객체2)
      : 인자로 주어진 2개의 객체의 주소값(참조값)을 비교하여 동일하면 true를 반환하는 메서드
  */

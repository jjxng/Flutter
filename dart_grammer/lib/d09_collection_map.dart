void main()
{
  ...
  */
  ...
  // Dart의 삼항 연산자로 앞의 값이 null이면 뒤의 값이 할당된다. 이래서 앞에 ?이 없음.
  int val2 = map2['홍길동'] ?? -1; //
  print(val2);

  // var 연상자의 경우 입력된 데이터에 따라 타입이 결정된다.
  ...
  // 반복
  print("==================================================");
  for (var key in map2.keys) {    // key set 명령 대신 keys.
    print('$key : ${map2[key]}');
  }
  print("==================================================");

...
class Page1 extends StatefulWidget {
  // main.dart에서 전달한 파라미터를 받기 위해 변수를 선언한 후 생성자에 추가
    ...
    return Scaffold(
      ...
      body: Center(
        child: Column(
          ...
          children: [
            ElevatedButton(
              ...
              onPressed: () async {
                ...
                // 새로운 페이지에서 콜백 데이터가 올 때까지 대기(await)한다.
                // 결과 데이터를 받을 변수는 var로 선언. String으로 받으면 에러
                // 발생. 이미 있는 페이지를 부름.
          ...
          // 앱 실행 초기에는 main.dart에서 전달한 '시작' 출력 된다.

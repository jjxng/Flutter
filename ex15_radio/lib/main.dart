          ...
          children: [
            ...
            ListTile(
              ...
              leading: Radio <Fruit>(
                ...
                value: Fruit.apple,
                /*
                  Flutter2.0에서 적용되면서 Null Safety가 적용되어 null 체크 부분이
                  강화되었다.
                */
            ...
            ListTile(
              ...
              leading: Radio <Fruit>(
                ...
                onChanged: (value) {
                  setState(() {
                    // 변수 뒤에 ! - 변수 값이 null이 들어오면 런 타임 에러 발생시킴
                    _myGroup1 = value!;
                    print(_myGroup1);
                  });
                },
            ...
            // 라디오 버튼의 영역이 넓어지므로 해당 하인을 클릭하면 된다.
            RadioListTile <Fruit>(
              title: const Text('사과'),
            ...
            RadioListTile <Fruit>(
              ...
              // 노멀 상태의 뱌경색은 테마로 변경 : unseletedWidgetColor
              onChanged: (value) {
                setState(() {
                  _myGroup2 = value!;
                  print(_myGroup2);

          ...
          children: [
            ...
            ElevatedButton(
              style: ElevatedButton.styleFrom(
                ...
                foregroundColor: Colors.white,  // 테두리 색
            ...
            Checkbox(
              ...
              // 노멀 상태의 배경색은 테마로 변경
              onChanged: (value) {  // 위에서 bool?처리했기 대문에 이곳에서는 안 씀
                setState(() {
                  _chk1 = value!;
                });
              }),
            Theme(
              data: Theme.of(context).copyWith(
                unselectedWidgetColor: Colors.red,  // 두 번째 테두리 색
              ),
              child: Checkbox(
                value: _chk2,
                checkColor: Colors.pinkAccent,  // 체크 안되었을 때 마크의 색
                activeColor: Colors.greenAccent,  // 체크 되었을 때 배경색

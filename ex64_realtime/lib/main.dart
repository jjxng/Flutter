...
class _MyHomePageState extends State<MyHomePage> {
  ...
  void initState() {
    ...
    _messagesRef = FirebaseDatabase.instance.ref('message');
    ...
    _messageSubscription = _messagesRef
    .limitToLast(10)
          ...
          children: [
            Flexible(
              child: Center(
                ...
                : Text(
                  'Error retrieving button tap countL\n${_error!.message}',
                ),
              ),
            ),
            ElevatedButton(
            ...
            ListTile(
              title: const Text('Anchor to buttom'),
              leading: Checkbox(
